    ...
    <div className="flex min-h-screen bg-muted/40">
      ...
      <aside className="fixed inset-y-0 left-0 z-10 hidden w-64 flex-col border-r bg-background sm:flex">
        <div className="flex h-16 items-center gap-2 border-b px-6">
          <div className="h-8 w-8 bg-primary rounded-full flex items-center justify-center text-white font-heading font-bold text-xs">
            SD
          </div>
      ...
      <main className="flex-1 sm:pl-64">
        <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b bg-background px-6 sm:px-8 shadow-sm">
          <h1 className="text-lg font-semibold tracking-tight">Sri Dental Clinic Admin</h1>
        </header>
